...
public class MockSecurityContestFactory implements WithSecurityContextFactory<MockMember> {
    ...
    public SecurityContext createSecurityContext(MockMember annotation) {
        ...
        UsernamePasswordAuthenticationToken token = new UsernamePasswordAuthenticationToken(memberInfo,
                annotation.password(), authorities);
