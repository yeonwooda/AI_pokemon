...
public class ApiUpdateService {
    ...
    public void update(int page) {
        ...
        String url = String.format("https://pokeqpi.co/api/v2/pokemon?offset=%dlimit=%d", offset, limit);
        ...
        for (UrlItem item : items) {
            ...
            String types = data1.getTypes().stream().map(d -> d.getType().getName())
                    .collect(Collectors.joining("||")); // 타입 1 || 타입 2 || 타입 3
            ...
            // 포켓몬 한글 이름, 포켓몬 한글 설명
            String url2 = String.format(" String url = \"https://pokeapi.co/api/v2/pokemon-species/%d",
                    data1.getId());
